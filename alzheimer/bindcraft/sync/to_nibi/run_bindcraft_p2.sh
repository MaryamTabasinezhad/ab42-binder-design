#!/bin/bash
#SBATCH --job-name=bc_p2
#SBATCH --output=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/logs/bc_ab42_p2_%j.out
#SBATCH --error=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/logs/bc_ab42_p2_%j.err
...
python -u "$REPO/bindcraft.py" \
  --settings "$SETTINGS/ab42_CEG_p2.json" \
