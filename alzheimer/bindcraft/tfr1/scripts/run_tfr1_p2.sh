#!/bin/bash
#SBATCH --job-name=bc_tfr1_p2
#SBATCH --output=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/tfr1/logs/bc_tfr1_p2_%j.out
#SBATCH --error=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/tfr1/logs/bc_tfr1_p2_%j.err
...
python -u "$REPO/bindcraft.py" \
  --settings "$SETTINGS/tfr1_AB_p2.json" \
