#!/bin/bash
#SBATCH --job-name=bc_tfr1_p1
#SBATCH --output=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/tfr1/logs/bc_tfr1_p1_%j.out
#SBATCH --error=/home/ghaedi/projects/def-ghaedi/ghaedi/protein/alzheimer/bindcraft/tfr1/logs/bc_tfr1_p1_%j.err
...
python -u "$REPO/bindcraft.py" \
  --settings "$SETTINGS/tfr1_AB_p1.json" \
