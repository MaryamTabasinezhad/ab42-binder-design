...
#SBATCH --output=/global/project/hpcg6049/protein/alzheimer/bindcraft/logs/bc_ab42_p1_%j.out
#SBATCH --error=/global/project/hpcg6049/protein/alzheimer/bindcraft/logs/bc_ab42_p1_%j.err
