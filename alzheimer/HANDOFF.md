...
- [x] **Stage 5 COMPLETE (2026-05-29):** All 23 Stage 4 survivors ranked by composite score (i_pAE 0.25, dG 0.15, binder_pLDDT 0.15, diversity 0.15, SAP 0.10, Tm 0.10, mono_pLDDT 0.10). 18 scaffolds, max 2/scaffold. Top: s967366_mpnn11 (score=0.793). Results: `filtering/stage5/stage5_ranked.csv`. All 23 advance to Stage 8 (pool < 50 synthesis target).
...
### Next up
- [ ] Stage 7.5 re-rank: If final TfR1 production batch adds >5 new Stage 7.4 survivors, re-rank and update top 50
- [ ] **Stage 8: Tandem fusion design** — combine top Aβ42 × top TfR1 arms with 10 linker variants (DEVELOPMENT_PLAN.md §8)
